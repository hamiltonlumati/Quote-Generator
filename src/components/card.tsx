    ...
    return(
        <div className={"w-1/2 mx-auto bg-white p-10 rounded text-"+color}>
            ...
            <div className='grid grid-cols-5 gap-4 mt-5'>
                ...
                <button type="button" className="col-start-3 col-span-3  p-3 rounded bg-green hover:bg-green-dark text-white text-lg justify-self-end" onClick={() => dispatch(generate())}>Generate</button>
            </div>
        </div>
    );
};
